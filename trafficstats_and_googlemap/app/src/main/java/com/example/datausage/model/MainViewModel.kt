...
class MainViewModel: ViewModel() {
    ...
    */
    ...
    private fun getDataUsage(){
        ...
        _totalDataUsage.value = _totalDataUsageR.value!! + _totalDataUsageT.value!!
    }
